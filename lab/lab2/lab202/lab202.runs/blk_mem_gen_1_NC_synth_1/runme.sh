...
HD_PWD='C:/Users/15774/lab202/lab202.runs/blk_mem_gen_1_NC_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_1_NC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_1_NC.tcl
