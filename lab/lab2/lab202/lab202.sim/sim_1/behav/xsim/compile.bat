...
REM
REM Generated by Vivado on Tue Mar 29 15:25:07 +0800 2022
...
echo "xvlog --incr --relax -prj lab202_vlog.prj"
call xvlog  --incr --relax -prj lab202_vlog.prj -log xvlog.log
